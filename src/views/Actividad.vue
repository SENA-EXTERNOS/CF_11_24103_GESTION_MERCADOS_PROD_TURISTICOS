    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo.color-acento-contenido
          h2 Presentación de productos turísticos

        p.mb-4 El objetivo de esta actividad es identificar los conocimientos adquiridos luego de la revisión del componente formativo sobre la presentación de productos turísticos.
